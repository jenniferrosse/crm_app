...
class GaragesControllerTest < ActionController::TestCase
  ...
  test "should create garage" do
    assert_difference('Garage.count') do
      post :create, garage: { address: @garage.address, rent: @garage.rent, type: @garage.type, unit_id: @garage.unit_id }
    end
  ...
  test "should update garage" do
    patch :update, id: @garage, garage: { address: @garage.address, rent: @garage.rent, type: @garage.type, unit_id: @garage.unit_id }
    assert_redirected_to garage_path(assigns(:garage))
  end
